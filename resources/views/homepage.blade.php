...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto+Mono:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,700&display=swap"
    rel="stylesheet">
    ...
    <div class="mentor-container" id="mentor-container">
      ...
      <div class="mentor-gallery">
        <div class="mentorCards-row-1">
          <img id="mentor1" class="mentors" onclick="showFace(1)" src="/image/mentors/technobox.png"
            alt="Technology Mentor">
          <img id="mentor2" class="mentors" onclick="showFace(2)" src="/image/mentors/businessbox.png"
            alt="Business Mentor">
          <img id="mentor3" class="mentors" onclick="showFace(3)" src="/image/mentors/designbox.png"
            alt="Design Mentor">
        </div>
        <div class="mentorCards-row-2">
          <img id="mentor4" class="mentors" onclick="showFace(4)" src="/image/mentors/businessbox.png"
            alt="Business Mentor">
          <img id="mentor5" class="mentors" onclick="showFace(5)" src="/image/mentors/technobox.png"
            alt="Technology Mentor">
          <img id="mentor6" class="mentors" onclick="showFace(6)" src="/image/mentors/businessbox.png"
            alt="Business Mentor">
        </div>
        <div class="mentorCards-row-3">
          <img id="mentor7" class="mentors" onclick="showFace(7)" src="/image/mentors/designbox.png"
            alt="Design Mentor">
          <img id="mentor8" class="mentors" onclick="showFace(8)" src="/image/mentors/businessbox.png"
            alt="Business Mentor">
          <img id="mentor9" class="mentors" onclick="showFace(9)" src="/image/mentors/technobox.png"
            alt="Technology Mentor">
        </div>
      </div>
    </div>
    ...
    <div class="about-container" id="aboutUs">
      ...
      <div class="about-mainText-container">
        <div class="about-mainText">
          Hackathon 6.0 merupakan puncak dari TechnoScape berupa kompetisi coding secara offline selama 48 jam, di mana
      ...
      <div class="about-button-container">
        <button class="about-button"><a
            href="https://drive.google.com/file/d/1FQef4_keY9dA3pWDiZAiuICxqEr8-iVJ/view">Guidebook</a></button>
      </div>
    ...
    <div class="FAQ-container" id="FAQ-container">
      ...
      <div class="question-1" id="question-container">
        <div class="FAQ-question" id="FAQ1">
          ...
          <img id="dropdown-1" src="/image/Benefits/dropdown.png" alt="">
        </div>
      ...
      <div class="question-3" id="question-container">
        ...
        <div id="detailsC" class="details">
          <p>
            Peserta hanya dapat bergabung dalam 1 tim, baik secara individu maupun tim (setiap tim dapat beranggotakan
            maksimal 4 orang).Peserta adalah warga negara Indonesia berusia 18 hingga 25 tahun untuk memenuhi
            syarat.Peserta harus menyerahkan dokumen yang dibutuhkan pada halaman Hackathon, seperti:
          </p>
        ...
        <div class="slider">
          ...
          <div class="slider-footer">
            ...
            <div class="slider-button">
              <button class="register-button"><a href="https://technoscape.id/techno-conference">Register
                  Here</a></button>
            </div>
          </div>
        </div>
      ...
      <div class="footer">
        ...
        <div class="right-footer">
          <div class="footer-logos">
            ...
            <a href="https://www.facebook.com/bina.nusantara.computer.club/"><img src="/image/facebook.png"
                alt="Facebook"></a>
            <a href="https://twitter.com/i/flow/login?redirect_after_login=%2FBNCC_Binus"><img src="/image/Twitter.png"
                alt="Twitter"></a>
            <a href="https://www.linkedin.com/company/bina-nusantara-computer-club/"><img src="/image/linkedin.png"
                alt="LinkedIn"></a>
          </div>
